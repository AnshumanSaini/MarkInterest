    ...
    <>
      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          ...
          <Link
            to={`user-profile/${pinDetail.posted_by}`}
            className="flex gap-2 mt-5 items-center bg-white rounded-lg"
          >
            <p className="font-semibold capitalize">{pinDetail?.posted_by}</p>
          </Link>
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            <Link to={`user-profile/${pinDetail.posted_by}`}>
              <img
                src={userData.image}
                alt="user-profile"
